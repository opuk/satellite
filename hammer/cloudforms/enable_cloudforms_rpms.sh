...
hammer repository-set enable --name "Red Hat CloudForms Management Engine 5.6 (RPMs)" --product "Red Hat CloudForms" --organization-id $ORG_ID --basearch x86_64 --releasever $RELEASEVER
